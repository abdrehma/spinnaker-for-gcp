...
gsutil -m cp -r ${CONFIG_BUCKET_BACKUP_URI} restored_backup && cd restored_backup
...
bold "Configuration applied."
# To diff this config with what was last deployed, go to:
